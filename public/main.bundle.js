    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesService.show(data.msg, { cssClass: 'alert-success', timeout: '3500' });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashMessagesService.show(data.msg, { cssClass: 'alert-danger', timeout: '3500' });
...
module.exports = "<div class=\"d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow\">\n    <h5 class=\"my-0 mr-md-auto font-weight-normal\">First MEAN App</h5>\n    <nav class=\"my-2 my-md-0 mr-md-3\">\n      <a [routerLinkActive]=\"['active']\" [routerLink]=\"['/']\" [routerLinkActiveOptions]=\"{ecxact:true}\" class=\"p-2 text-dark\">Home</a>\n      <a *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/dashboard']\" [routerLinkActiveOptions]=\"{ecxact:true}\" class=\"p-2 text-dark\">Dashboard</a>\n      <a *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/profile']\" [routerLinkActiveOptions]=\"{ecxact:true}\" class=\"p-2 text-dark\">Profile</a>\n      <a *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/login']\" [routerLinkActiveOptions]=\"{ecxact:true}\" class=\"p-2 text-dark\">Login</a>\n      <a *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/register']\" [routerLinkActiveOptions]=\"{ecxact:true}\" class=\"p-2 text-dark\">Register</a>\n      <a *ngIf=\"authService.loggedIn()\" (click)=\"onLogoutClick()\" href=\"#\" class=\"p-2 text-dark\">Logout</a>\n    </nav>\n  </div>\n\n"
...
module.exports = "<div *ngIf=\"user\">\n  <h2 class=\"text-center\">Welcome, {{user.name}} <br/>aka<br/> {{user.username}}</h2>\n</div>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('You are now a member of this awesome site', { cssClass: 'alert-success', timeout: 3500 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesService.show('Registration failed', { cssClass: 'alert-danger', timeout: 3500 });
